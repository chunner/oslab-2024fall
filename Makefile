...
CFLAGS          = -O0 -fno-builtin -nostdlib -nostdinc -Wall -mcmodel=medany -ggdb3 -Wno-int-conversion 
...
QEMU_DEBUG_OPT  = -s -S
QEMU_DEBUG_OPT2  = -gdb tcp:1235 -S
QEMU_SMP_OPT	= -smp 2
...
image: $(ELF_CREATEIMAGE) $(ELF_BOOT) $(ELF_MAIN) $(ELF_USER)
	...
	dd if=/dev/zero of=$(DIR_BUILD)/image oflag=append conv=notrunc bs=600MB count=1
