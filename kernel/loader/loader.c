...
#define taskinfo_loc    0x50500000          # 栈顶
...
uint64_t load_task_img(char taskname[])
{
    ...
    task_info_t *taskinfo = (task_info_t *)(taskinfo_loc);
    int i;      // task index
    for(i = 0; i < * tasknum; i ++){
